let RecomendedProduct = [
  {
    ...
    img: "https://cdn01.pharmeasy.in/dam/products_otc/I04915/horlicks-classic-malt-nutrition-drink-jar-of-500-g-2-1601563018.jpg?dim=224x0&dpr=1&q=100",
    description:
  ...
  },
  {
    ...
    price: "115",
    img: "https://cdn01.pharmeasy.in/dam/products_otc/I37008/sensodyne-fresh-mint-toothpaste-tube-of-75-g-1-1601563877.jpg?dim=224x0&dpr=1&q=100",
    description:
      "Horlicks Classic Malt Nutrition Drink Jar of 500g is a highly nutritious drink. Drinking the suggested serving of Horlicks regularly is scientifically proven to improve growth in children, increasing both height and weight visibly within 90 days.",
  },
  {
    ...
    price: "115",
    img: "https://cdn01.pharmeasy.in/dam/products_otc/I35532/volini-maxx-pain-relief-spray-25-gm-2-1614077241.jpg?dim=224x0&dpr=1&q=100",
    description:
      "Horlicks Classic Malt Nutrition Drink Jar of 500g is a highly nutritious drink. Drinking the suggested serving of Horlicks regularly is scientifically proven to improve growth in children, increasing both height and weight visibly within 90 days.",
  },
  {
    ...
    price: "115",
    img: "https://cdn01.pharmeasy.in/dam/products_otc/F31145/zandu-pain-relief-balm-bottle-of-50-ml-2-1613391775.jpg?dim=224x0&dpr=1&q=100",
    description:
      "Horlicks Classic Malt Nutrition Drink Jar of 500g is a highly nutritious drink. Drinking the suggested serving of Horlicks regularly is scientifically proven to improve growth in children, increasing both height and weight visibly within 90 days.",
  },
  {
    ...
    price: "115",
    img: "https://cdn01.pharmeasy.in/dam/products_otc/I08068/moov-pain-relief-spray-bottle-of-50-g-2-1610440319.jpg?dim=224x0&dpr=1&q=100",
    description:
      "Horlicks Classic Malt Nutrition Drink Jar of 500g is a highly nutritious drink. Drinking the suggested serving of Horlicks regularly is scientifically proven to improve growth in children, increasing both height and weight visibly within 90 days.",
  },
  {
    ...
    price: "115",
    img: "https://cdn01.pharmeasy.in/dam/products_otc/I35832/digene-gel-acidity-gas-relief-200ml-mixed-fruit-flavour-2-1600002861.jpg?dim=224x0&dpr=1&q=100",
    description:
      "Horlicks Classic Malt Nutrition Drink Jar of 500g is a highly nutritious drink. Drinking the suggested serving of Horlicks regularly is scientifically proven to improve growth in children, increasing both height and weight visibly within 90 days.",
  },
  {
  ...
  },
  {
    ...
    price: "115",
    img: "https://cdn01.pharmeasy.in/dam/products_otc/I07455/cadbury-bournvita-lil-champs-nutrition-drink-jar-of-500-g-2-1613111508.jpg?dim=224x0&dpr=1&q=100",
    description:
      "Horlicks Classic Malt Nutrition Drink Jar of 500g is a highly nutritious drink. Drinking the suggested serving of Horlicks regularly is scientifically proven to improve growth in children, increasing both height and weight visibly within 90 days.",
  },
  {
    ...
    price: "115",
    img: "https://cdn01.pharmeasy.in/dam/products_otc/L84830/kesh-king-anti-hairfall-shampoo-bottle-of-200-ml-2-1613110248.jpg?dim=224x0&dpr=1&q=100",
    description:
      "Horlicks Classic Malt Nutrition Drink Jar of 500g is a highly nutritious drink. Drinking the suggested serving of Horlicks regularly is scientifically proven to improve growth in children, increasing both height and weight visibly within 90 days.",
  },
];
  ...
  if (localStorage.getItem("RecomendedProduct") == null) {
    localStorage.setItem("RecomendedProduct", JSON.stringify(RecomendedProduct)); data
  }
  ...
  function appendpro() {
    ...
    data.forEach(function (el) {
      ...
      p_Price.innerHTML =` ${100-(p_Price.innerHTML % Math.floor(Math.random() * 10))} `
 ...
 // onclikc event for slider
    function slider() {
    let sapn = document.getElementById("RecomendedProduct").getElementsByTagName("span");
   let div = document.getElementById("RecomendedProduct").getElementsByTagName("div");
        let l = 0;
        sapn[1].onclick = () => {
            l++//for right scroll
            for (var i of div) {
